#ifndef POR_MODULE_TRANSITION_SYSTEM_ACTION_TABLE_H_
#define POR_MODULE_TRANSITION_SYSTEM_ACTION_TABLE_H_
...
#endif  // POR_MODULE_TRANSITION_SYSTEM_ACTION_TABLE_H_
